<!DOCTYPE html>
<html lang="en">
@include('ministry_of_health.components.metadata')
...
@include('ministry_of_health.components.aside')

  <!-- Content Wrapper. Contains page content -->
@yield('minister')
  <!-- /.content-wrapper -->
  @include('ministry_of_health.components.footer')
...
<!-- ./wrapper -->
	...
	<!-- Sidebar -->
@include('ministry_of_health.components.chat')
	<!-- Page Content overlay -->
	
	
@include('ministry_of_health.components.js')
</body>
</html>
