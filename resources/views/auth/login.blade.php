					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0">Sign in to continue to NHMARS.</p>							
							</div>
							<div class="p-40">
								...
								<form action="{{ route('login') }}" method ="post">
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input class="form-control ps-15 bg-transparent" type="password" placeholder="Password"name="password" required autocomplete="current-password">
										</div>
									</div>
									  <div class="row">
										<div class="col-6">
										...
										<div class="col-12 text-center">
										  <button type="submit" class="btn btn-dark mt-10">SIGN IN</button>
										</div>
										<!-- /.col -->
									  </div>
								</form>	
