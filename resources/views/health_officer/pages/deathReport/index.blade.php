    ...
    <div class="container-full">
      ...
      <section class="invoice printableArea">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="{{ route('doctor.detail_death') }}" method="GET">
        ...
        <div class="row">
                <div class="col-md-6 text-center">
                    <p class="text-fade text-primary text-center">Male to Female Death Ratio Per Month</p>
        ...
        <div class="row">
          <div class="col-12 text-end">
              ...
              <div class="total-payment">
                  <h3><b>Total Death :</b> {{$totalChildren}}</h3>
              </div>
...
<script>
	var ctx=document.getElementById('deathpieChart').getContext('2d');
	var deathChart=new Chart(ctx,{
type:'pie',
data:{
